...
To establish a causal link between reordering and performance, we will profile the compiled CUDA kernels using \textbf{NVIDIA Nsight Compute (\texttt{ncu})} to measure \texttt{l2\_cache\_hit\_rate}: the fraction of L2 sector requests serviced without going to HBM.
